...
typedef enum {
  ...
  PTPGP_PACKET_PARSER_TOKEN_PUBLIC_KEY,
  PTPGP_PACKET_PARSER_TOKEN_PUBLIC_SUBKEY,

  PTPGP_PACKET_PARSER_TOKEN_PRIVATE_KEY,
  PTPGP_PACKET_PARSER_TOKEN_PRIVATE_SUBKEY,
