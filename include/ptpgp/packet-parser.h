...
typedef enum {
  ...
  PTPGP_PACKET_PARSER_TOKEN_SYMMETRIC_ENCRYPTED_SESSION_KEY,
  ...
  PTPGP_PACKET_PARSER_TOKEN_KEY_PACKET_HEADER,
  PTPGP_PACKET_PARSER_TOKEN_SECRET_KEY_PACKET_HEADER,
  PTPGP_PACKET_PARSER_TOKEN_SECRET_KEY_PACKET_CHECKSUM,
...
typedef enum {
  ...
  PTPGP_PACKET_PARSER_STATE_SECRET_KEY_FIELDS,
  PTPGP_PACKET_PARSER_STATE_SECRET_KEY_SYMMETRIC_ALGORITHM,
  PTPGP_PACKET_PARSER_STATE_SECRET_KEY_S2K,
  PTPGP_PACKET_PARSER_STATE_SECRET_KEY_IV,
  PTPGP_PACKET_PARSER_STATE_SECRET_KEY_CHECKSUM,
...
struct ptpgp_packet_parser_t_ {
  ...
  /* used by key packet to determine remaining number of mpis */
  size_t num_mpis;

  size_t symmetric_block_size;
